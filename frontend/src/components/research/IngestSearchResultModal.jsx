            ...
            <ol className="text-xs text-slate-600 leading-relaxed pl-5 list-decimal space-y-1">
              <li>
                {willUsePdf ? (
                  ...
                  <>Tìm bản PDF Open Access qua <code className="font-mono text-[11px]">DOI</code> + scrape trang gốc</>
                ) : (
                  <>Quét trang gốc tìm liên kết PDF; nếu không có sẽ xử lý nội dung HTML</>
                )}
              </li>
              <li>Trích xuất văn bản, bảng và công thức</li>
